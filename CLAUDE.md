...
- [言語別規約](#言語別規約)
  - [TypeScript/React/Next.js](#typescriptreactnextjs)
    - [フレームワーク \& 構成](#フレームワーク--構成)
    - [スタイリング](#スタイリング)
    - [ユーザー通知](#ユーザー通知)
    - [コンソール出力](#コンソール出力)
    - [型安全性](#型安全性)
    - [React/Next.js パターン](#reactnextjs-パターン)
  - [Python](#python)
    - [ロギング](#ロギング)
    - [型ヒント](#型ヒント)
    - [テスト](#テスト)
...
新しいメジャータスクや機能開発を開始する前に、下記のGitHubプロジェクトを確認し、現在のプロジェクト優先度と計画されたタスクを理解すること。

https://github.com/users/aromarious/projects/6

ユーザーのリクエストがGitHubプロジェクト内の項目と一致する場合は、それを言及し、作業の進捗に応じてGitHubプロジェクトのステータスを更新すること。
