...
export default function SettingsPage() {
	...
	useEffect(() => {
		if (config) {
			...
			// @ts-ignore - config.settings type update needed or just ignore for now
			...
			<div className="container mx-auto px-6 py-8 min-h-screen flex flex-col">
				...
				<div className="flex flex-1 gap-6 items-start">
					...
					<div
						...
						role="tablist"
					>
						<TabButton id="general" icon={Settings} label={t("General")} />
						...
						/>
						<TabButton id="projects" icon={FolderGit2} label={t("Projects")} />
						<TabButton
							id="rules"
							icon={ListFilter}
						...
						/>
						<hr className="my-2 border-base-content/10" />
						<TabButton id="plugins" icon={Cpu} label={t("Plugins")} />
