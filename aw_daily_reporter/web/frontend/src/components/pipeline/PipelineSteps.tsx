      ...
      >
        {stages.map((stage, idx) => (
          ...
          >
            <PipelineStageNode
              stage={stage}
              isActive={selectedStage === stage.index}
              isPast={stage.index < selectedStage}
  ...
  return (
    ...
    >
      {isPast ? (
        ...
        <Circle size={isVertical ? 14 : 16} className="fill-current" />
      ) : (
  ...
  return (
    ...
    >
      <StageStatusIcon
        ...
        isVertical={isVertical}
      />
      <StageContent stage={stage} isActive={isActive} isVertical={isVertical} />
    </button>
  )
}
